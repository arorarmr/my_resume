...
txt('**Bixby Voice Assistant Analytics** \nData Scientist, Samsung Research, Bangalore, India',
'2020-Present')
st.markdown('''
...
txt('**Non-Invasive Glucose Monitoring** \nData Scientist, Samsung Research, Bangalore, India',
'2018-2020')
st.markdown('''
...
txt('**OpenCL APIs Implementation For GPU** \nLead Software Developer, Samsung Research, Bangalore, India',
'2016-2018')
st.markdown('''
...
txt('**Performance Improvement using OpenCL and OpenGL** \nSenior Software Developer, Samsung Research, Bangalore, India',
'2014-2016')
st.markdown('''
...
txt('**Crypt Analysis using hybrid computing** \nSoftware Developer, C-DAC R&D, Bangalore, India',
'2012-2014')
st.markdown('''
