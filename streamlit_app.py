...
def txt4(a, b, c):
  col1, col2, col3 = st.columns([1,3,0.75])
  with col1:
    st.markdown(f'`{a}`')
  with col2:
    st.markdown(b)
...
txt('**Bixby Voice Assistant Analytics** br/Data Scientist, Samsung Research, Bangalore, India',
'2020-Present')
st.markdown('''
...
txt('**Non-Invasive Glucose Monitoring** br/Data Scientist, Samsung Research, Bangalore, India',
'2018-2020')
st.markdown('''
...
txt('**OpenCL APIs Implementation For GPU** br/Lead Software Developer, Samsung Research, Bangalore, India',
'2016-2018')
st.markdown('''
...
txt('**Performance Improvement using OpenCL and OpenGL** br/Senior Software Developer, Samsung Research, Bangalore, India',
'2014-2016')
st.markdown('''
...
txt('**Crypt Analysis using hybrid computing** br/Software Developer, C-DAC R&D, Bangalore, India',
'2012-2014')
st.markdown('''
...
txt4('Award','Spot Award for relentless effort and contribution in glucose monitoring project','')
txt4('Award','Employee of the Month Award for quick learning and fast project delivery','')
txt4('Award','C-DAC Best Student Award for best performance among all students','')
